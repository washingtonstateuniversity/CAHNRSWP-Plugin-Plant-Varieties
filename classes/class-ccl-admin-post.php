...
class CCL_Admin_Post_Varieties {
	
	protected function save_post_admin( $post_id , $post_key , $data_type , $nonce ) {
	...
	protected function update_post_content( $control, $post_id , $html , $nonce, $remove_action ){
		...
		remove_action( $remove_action[0] , array( $control, $remove_action[1] ) );
	...
	protected function check_can_edit( $post_id , $nonce ){
	...
	public function to_shortcode( $shortcode , $attrs , $content = null , $exclude = array() ) {
